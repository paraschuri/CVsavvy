    ...
    return (
        <nav className="w-full shadow-md shadow-[#71767c] z-10 absolute top-0 left-0 bg-[#474B4F]">
            <div className='md:flex max-w-[1300px] bg-[#474B4F] m-auto items-center justify-between py-4 md:px-10 px-1'>
                ...
                <ul className={`absolute left-0 w-full md:w-auto md:flex md:items-center md:gap-6 pb-6 md:pb-0 md:static bg-[#474B4F] md:z-auto z-[-1] md:pl-0 pl-10 ${isOpen ? 'top-16 transition-all duration-400 ease-in':'top-[-500px]'}`}>
                ...
                <button onClick={() => setIsOpen(!isOpen)} className="text-4xl absolute right-8 top-6 cursor-pointer md:hidden">
