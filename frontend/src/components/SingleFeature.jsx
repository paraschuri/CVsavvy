...
export function SingleFeature({name,info,img}){
    return (
        <Card className={`rounded-3xl px-6 m-6 flex-col items-center justify-center lg:max-w-[26rem] h-100 w-60 shadow-lg bg-gradient-radial from-lightBlack via-darkBlack to-black overflow-hidden`} >
