            ...
            <div className="text-white mx-auto md:px-14 md:pr-16 px-4 w-screen">
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="lg:mt-16 lg:w-[67%] lg:ml-10 lg:block flex flex-col items-center">
                        ...
                        <div className="lg:mt-10 mt-4 flex justify-center">
                            {!user ?
                                <Link to="/start" className="bgGradient py-2 px-6 mt-6 sm:mt-8 text-sm rounded-3xl font-semibold text-black">Get Started</Link> :
                                user.user ?
                                    <Link to="/user" className="bgGradient py-2 px-6 mt-6 sm:mt-8 text-sm rounded-3xl font-semibold text-black">Check your Resume</Link> :
                                    <Link to="/recruiter" className="bgGradient py-2 px-6 mt-6 sm:mt-8 text-sm rounded-3xl font-semibold text-black">Rank the resume</Link>
                            }
                        </div>
                    </div>
