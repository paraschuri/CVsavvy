    ...
    <>
        <div>
            <div className='flex flex-col justify-center min-[1160px]:mt-10 items-start text-white mx-auto md:px-14 md:pr-16 px-4 w-5/6 gap-4'>
                ...
                <div className=' text-xs md:text-sm min-[1160px]:text-min-[1160px]'>Our mission is simple: to transform your career aspirations into tangible opportunities. Whether you're a recent graduate stepping into the workforce or a seasoned professional seeking advancement, we're here to elevate your resume to new heights. We believe that every career journey deserves a compelling narrative, and we're committed to helping you articulate yours effectively.</div>
                ...
                <div className=' text-xs md:text-sm min-[1160px]:text-min-[1160px]'>At CVSavvy, we're not just in the business of crafting resumes; we're in the business of shaping careers. Join us on this journey, and let's unlock the potential of your professional trajectory together.</div>
            </div>
